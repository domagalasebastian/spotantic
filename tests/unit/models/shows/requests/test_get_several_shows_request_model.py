...
def test_get_several_shows_request_model_serializes_ids_and_market(example_instances_of_type) -> None:
...
def test_get_several_shows_request_model_rejects_too_many_ids(example_instances_of_type) -> None:
    example_id = example_instances_of_type[SpotifyItemID]
